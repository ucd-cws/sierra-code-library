...
# Set local variables:
config_join_field = "BASINNAME" # the field that it will attempt to join from
...
config_input_gdb = os.path.join(os.getcwd(),"validation_run.gdb")
config_filters = range(1980,2001)
