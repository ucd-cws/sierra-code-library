...
class plot_series:
	def __init__(self,field = None,color="#000000",future_color="#999999",shared_axis=None):
		self.field = field
		self.color = color
